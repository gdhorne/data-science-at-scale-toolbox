...
#                                                                             #
# Manage containers for the Data Science at Scale Specialization              #
...
function display_banner() {
	...
	echo
	echo "Data Science Toolbox for 'Data Science at Scale Specialization'"
	...
	echo
	echo "Further informmation about the Data Science at Scale Specialization"
	echo "offered by University of Washington as a Massively Open-Online"
	echo "Course (MOOC) using the Coursera platform can be found at"
	echo -e "\n\tData Science at Scale Specialization"
	echo -e "\t\thttps://www.coursera.org/specializations/data-science"
	echo -e "\n\tCoursera\n\t\thttps://coursera.org"
	echo
	echo "This software and associated documentation has been developed"
	echo "independently of University of Washington and Coursera. It is"
	echo "provided as a convenience to participants in the Data Science at"
	echo "Scale Specalization."
	echo
	echo
}
